...
public:
	...
	HRESULT Resize(ID3D11Device* pd3dDevice, int iWidth, int iHeight)
	{
		...
		// Setup the camera's projection parameters
			...
			m_mViewport.Width = (float)iWidth;
			m_mViewport.Height = (float)iHeight;
	...
	{		
		DXUT_BeginPerfEvent(DXUT_PERFEVENTCOLOR, L"Standar Ray Casting");
		...
		m_cbPerFrame.mWorldView = XMMatrixTranspose(m_World*m_View);
